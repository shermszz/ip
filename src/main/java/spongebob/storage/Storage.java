...
public class Storage {
     ...
     * @throws SpongebobException If an I/O error occurs during reading.
     */
    public ArrayList<Task> load() throws SpongebobException {
        ...
        try {
            ...
            throw new SpongebobException("Error loading tasks: " + e.getMessage());
        }
        return loadedTasks;
    }
